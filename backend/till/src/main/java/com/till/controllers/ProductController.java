...
public class ProductController {
	...
	public String createProduct(@Valid ProductParams params) {
		return this.productService.createProduct(params);
	}
	
	@PutMapping("/{productId}")
	public void updateProduct(@Valid ProductParams params, @Valid @Pattern(regexp = AppConstants.UUID_PATTERN) String productId) {
